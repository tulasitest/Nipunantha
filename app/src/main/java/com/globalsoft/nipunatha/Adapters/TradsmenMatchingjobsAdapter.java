...
public class TradsmenMatchingjobsAdapter extends RecyclerView.Adapter<TradsmenMatchingjobsAdapter.Recyclerviewholder> {
    private FragmentActivity activity;

    private List<tradesmenJobMatch.ResponseBean> arrayList;

    public TradsmenMatchingjobsAdapter(FragmentActivity activity, List<tradesmenJobMatch.ResponseBean> arrayList) {
    ...
    public Recyclerviewholder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view;
        TradsmenMatchingjobsAdapter.Recyclerviewholder recyclerViewholder;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.li_tradsmenmatchjobs, parent, false);
        recyclerViewholder = new TradsmenMatchingjobsAdapter.Recyclerviewholder(view);
    ...
    public void filterList(List<tradesmenJobMatch.ResponseBean> arrayList) {
        this.arrayList = arrayList;
