...
public class TradsmenConfirmJobAdapter extends RecyclerView.Adapter <TradsmenConfirmJobAdapter.Recyclerviewholder> {
    ...
    public Recyclerviewholder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view;
        TradsmenConfirmJobAdapter.Recyclerviewholder recyclerViewholder;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.li_tradsmenconfirmedjobs, parent, false);
        recyclerViewholder = new TradsmenConfirmJobAdapter.Recyclerviewholder(view);
    ...
    public void onBindViewHolder( Recyclerviewholder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            holder.btn_contactcustomer.setVisibility(View.GONE);
            ...
            holder.btn_contactcustomer.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public static class Recyclerviewholder extends RecyclerView.ViewHolder{
        ...
        Button btn_contactcustomer, btn_close, btn_moredetails;
            ...
            public Recyclerviewholder(View view){
                ...
                btn_contactcustomer = (Button) view.findViewById(R.id.btn_contactcustomer);
